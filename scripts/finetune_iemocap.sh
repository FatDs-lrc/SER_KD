...
cmd="python train.py  --gpu_ids=$gpu
--dataset_mode=audio_finetune   --A_db_dir=/data4/lrc/movie_dataset/dbs/iemocap/comparE.db
--input_dim=130
--model=finetune --pretrained_dir=checkpoints/XV4_10_4layer_enc256_layer6_nhead4_ffn512_run2 --pretrained_epoch=15
...
--name=Finetune_IEMOCAP_91-1-5 --suffix=num-layer{num_layers}_nhead{nhead}_dim-feedforward{dim_feedforward}_lr-{lr}_run{run_idx} 
--cvNo=$i"
