...
--dnn_layers=128,128,12
--hidden_size=128 --embd_method=maxpool
--niter=20 --niter_decay=30 --verbose --beta1=0.9 --init_type kaiming
--batch_size=64 --lr=5e-4 --run_idx=$run_idx --enc_hidden_size=32 --bidirection
--name=cnn1d+dnn --suffix=enc{enc_hidden_size}_dnn{dnn_layers}_bi{bidirection}_run{run_idx}
--cvNo=$i"
