...
class Iemocap10foldDataset(BaseDataset):
    ...
    def modify_commandline_options(parser, isTrain=None):
        ...
        parser.add_argument('--A_type', type=str, default='comparE')
        parser.add_argument('--V_type', type=str, default='denseface')
        parser.add_argument('--L_type', type=str, default='text')
        return parser
    ...
    def __init__(self, opt, set_name):
        ...
        super().__init__(opt)
        cvNo = opt.cvNo
        acoustic_ft_type = opt.A_type
        lexical_ft_type = opt.L_type
        visual_ft_type = opt.V_type
        data_path = "/data7/lrc/IEMOCAP_features_npy/feature/{}/{}/"
...
if __name__ == '__main__':
    class test:
        ...
        A_type = 'fbank'
        V_type = 'denseface'
        L_type = 'bert_token_ids' 
    
    opt = test()
    a = Iemocap10foldDataset(opt, 'trn')
    data = a[0]
