...
class AudioPartDataset(BaseDataset):
    @staticmethod
    def modify_commandline_options(parser, isTrain=None):
        parser.add_argument('--cvNo', type=int, help='which cross validation set')
        parser.add_argument('--ft_type', type=str, default='comparE', help='which cross validation set')
    ...
    def __init__(self, opt, set_name):
        ...
        super().__init__(opt)
        cvNo = opt.cvNo
        acoustic_ft_type = opt.ft_type + opt.ratio
